        ...
        <div class="row">
            <div class="col-md-4" style="margin-top:20px; ">
                <form action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <span style="color:rgb(96, 96, 96); font-size:14px;">Admin No:</span>
                            <input type="text" class="bir" name="adminno" id="adminno">
                        </div>
                    </div>
                    <div class="row sutun">
                        <div class="col">
                            <span style="color:rgb(96, 96, 96); font-size:14px;">Şifre:</span>
                            <input type="password" class="iki" name="adminsifre" id="adminsifre">
                        </div>
                    </div>
                    <div class="row">
                        <button
